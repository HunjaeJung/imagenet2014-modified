...
% The ILSVRC is a benchmark in object category classification and detection on hundreds of object categories and millions of images.
% And this competition is one of the largest and the most challenging computer vision challenge.
% In this competition, there were 3 tasks which were (1) image classification, (2) singe-object localization, and (3) several objects detection.
