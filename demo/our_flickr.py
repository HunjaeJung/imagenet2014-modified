...
MODEL_FILE_STYLE = caffe_root + 'models/finetune_flickr_style/deploy.prototxt'
PRETRAINED_STYLE = caffe_root + 'models/finetune_flickr_style/finetune_flickr_style.caffemodel'

MODEL_FILE_IMGNET = caffe_root + 'models/bvlc_reference_caffenet/deploy.prototxt'
PRETRAINED_IMGNET = caffe_root + 'models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel'
